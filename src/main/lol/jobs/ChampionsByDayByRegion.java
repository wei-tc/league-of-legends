...
public class ChampionsByDayByRegion extends Configured implements Tool
{
    ...
    public static void main( String[] args ) throws Exception
    {
        ...
        for ( String r : REGIONS )
        {
            ...
            next[1] = args[0] + r;
            next[2] = r;
            ToolRunner.run( new ChampionsByDayByRegion(), next );
        }
    }
    ...
    public int run( String[] args ) throws Exception
    {
        ...
        Job job = Job.getInstance( conf, "championsByDayByRegion" );
        job.setJarByClass( ChampionsByDayByRegion.class );
    ...
    public static class RankedRichMapper extends Mapper<Object, Text, Text, Text>
    {
                ...
                throws IOException, InterruptedException
        {
                 ...
                 && RANKED.contains( match.get( QUEUE_TYPE ).toString() ) )
            {
                ...
                {
                    context.write( DATE, new Text(c.toString()) );
                }
            }
        }
    }
