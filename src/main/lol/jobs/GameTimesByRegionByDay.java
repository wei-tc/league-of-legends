...
import static lol.util.TimeProcessing.getStartDayTime;

public class GameTimesByRegionByDay extends Configured implements Tool
{
    ...
    public static void main( String[] args ) throws Exception
    {
        ...
        for ( String r : REGIONS )
        {
            ...
            next[1] = args[0] + r;
            next[2] = r;
            ToolRunner.run( new GameTimesByRegionByDay(), next );
        }
    }
    ...
    public int run( String[] args ) throws Exception
    {
        ...
        Job job = Job.getInstance( conf, "gameTimesByRegionByDay" );
        job.setJarByClass( GameTimesByRegionByDay.class );
    ...
    {
        private static final Text START_DAY_TIME = new Text();
                ...
                throws IOException, InterruptedException
        {
            ...
            {
                START_DAY_TIME.set( getStartDayTime( match.get( END_TIME ).toString(),
                                                     match.get( LENGTH ).toString() ) );
                context.write( START_DAY_TIME, ONE );
            }
        }
    }
